...
/**************************************************
 * Purpose: To include the pinout definitions
 * contained within "openesc_xxx.h"
 *
 * Usage: This file should be included in all files
 *  that are part of the OpenESC project
*************************************************/
